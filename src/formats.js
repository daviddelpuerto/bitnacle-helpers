function simple({
  time, level, userAgent, req = {}, statusCode, extra = {}, elapsedTime, message,
}) {
  ...
  const messageObject = {
    time, level, method, endpoint, remoteAddress, userAgent, id, statusCode, ...extra, elapsedTime, message,
  };
...
const extended = (logMessageObject) => JSON.stringify(logMessageObject);
